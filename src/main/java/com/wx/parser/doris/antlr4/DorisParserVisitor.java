...
public interface DorisParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code insertIntoQuery}
	 * labeled alternative in {@link DorisParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInsertIntoQuery(DorisParser.InsertIntoQueryContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code resourceLoad}
	 * labeled alternative in {@link DorisParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitResourceLoad(DorisParser.ResourceLoadContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code bracketJoinHint}
	 * labeled alternative in {@link DorisParser#joinHint}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBracketJoinHint(DorisParser.BracketJoinHintContext ctx);
	/**
	 * Visit a parse tree produced by the {@code commentJoinHint}
	 * labeled alternative in {@link DorisParser#joinHint}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCommentJoinHint(DorisParser.CommentJoinHintContext ctx);
	/**
