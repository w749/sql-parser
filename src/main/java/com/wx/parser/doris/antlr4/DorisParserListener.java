...
public interface DorisParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code insertIntoQuery}
	 * labeled alternative in {@link DorisParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterInsertIntoQuery(DorisParser.InsertIntoQueryContext ctx);
	/**
	 * Exit a parse tree produced by the {@code insertIntoQuery}
	 * labeled alternative in {@link DorisParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitInsertIntoQuery(DorisParser.InsertIntoQueryContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code resourceLoad}
	 * labeled alternative in {@link DorisParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterResourceLoad(DorisParser.ResourceLoadContext ctx);
	/**
	 * Exit a parse tree produced by the {@code resourceLoad}
	 * labeled alternative in {@link DorisParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitResourceLoad(DorisParser.ResourceLoadContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code bracketJoinHint}
	 * labeled alternative in {@link DorisParser#joinHint}.
	 * @param ctx the parse tree
	 */
	void enterBracketJoinHint(DorisParser.BracketJoinHintContext ctx);
	/**
	 * Exit a parse tree produced by the {@code bracketJoinHint}
	 * labeled alternative in {@link DorisParser#joinHint}.
	 * @param ctx the parse tree
	 */
	void exitBracketJoinHint(DorisParser.BracketJoinHintContext ctx);
	/**
	 * Enter a parse tree produced by the {@code commentJoinHint}
	 * labeled alternative in {@link DorisParser#joinHint}.
	 * @param ctx the parse tree
	 */
	void enterCommentJoinHint(DorisParser.CommentJoinHintContext ctx);
	/**
	 * Exit a parse tree produced by the {@code commentJoinHint}
	 * labeled alternative in {@link DorisParser#joinHint}.
	 * @param ctx the parse tree
	 */
	void exitCommentJoinHint(DorisParser.CommentJoinHintContext ctx);
	/**
